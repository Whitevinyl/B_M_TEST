...
proto.createComponent = function(componentName,args,mods) {
    ...
    switch (componentName) {
        ...
        case 'testing':
            ...
            settings.args.push( pick( args[0], {mod: 0, min: tombola.rangeFloat(1,70), max: tombola.rangeFloat(80,4000) }) ); // frequency
            settings.args.push( pick( args[1], {mod: 1, min: 0, max: tombola.rangeFloat(0.2,4) }) ); // amp
            settings.mods.push( pick( mods[0], this.createMod('perlin',[tombola.rangeFloat(0.001,2)])) );
            settings.mods.push( pick( mods[1], this.createMod('perlin',[tombola.rangeFloat(0.01,1)])) );
            break;
